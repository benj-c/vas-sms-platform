...
public interface ApiRepository extends JpaRepository<ApiEntity, Long> {
    ...
    @Query("select new com.sys.vas.management.dto.ApiXmlResponseDto(api.id, api.name, api.description, his.version, his.commitId, his.commitMessage, his.isActive, his.xml) from ApiEntity api, ApiHistoryEntity his where api.id = his.api.id and api.id = :id and his.commitId = :commit")
